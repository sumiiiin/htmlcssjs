...
<html>
	...
	<body>
		...
		<div class="container">
		  ...
		  <p style="color:#ff00ff">Light grey background color.</p>
		</div>
		
		<div class="container">
		  <h2>Background Color with Contrasting Text Color</h2>
		  <p class="bg-primary text-light">This text is important.</p>
		  ...
		  <p style="background-color: gold">Light grey background color.</p>
		</div>
